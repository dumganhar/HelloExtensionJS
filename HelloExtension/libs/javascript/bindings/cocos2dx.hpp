...
extern JSClass  *js_cocos2dx_CCControl_class;
extern JSObject *js_cocos2dx_CCControl_prototype;

JSBool js_cocos2dx_CCControl_constructor(JSContext *cx, uint32_t argc, jsval *vp);
void js_cocos2dx_CCControl_finalize(JSContext *cx, JSObject *obj);
void js_register_cocos2dx_CCControl(JSContext *cx, JSObject *global);
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_CCControl_sendActionsForControlEvents(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_setSelected(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_setOpacity(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_getDefaultTouchPriority(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_setHighlighted(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_isHighlighted(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_isEnabled(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_isSelected(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_init(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_getOpacity(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_setDefaultTouchPriority(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_setEnabled(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_getState(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_getColor(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_getTouchLocation(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_setColor(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_isTouchInside(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_registerWithTouchDispatcher(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_create(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_CCControl(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_CCScale9Sprite_setOriginalSize(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_CCScale9Sprite_node(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCScale9Sprite_spriteWithFile(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCScale9Sprite_create(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCScale9Sprite_spriteWithSpriteFrameName(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCScale9Sprite_createWithSpriteFrameName(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCScale9Sprite_spriteWithSpriteFrame(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_CCControlButton_getIsPushed(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_CCControlButton_getAdjustBackgroundImage(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_CCControlButton_buttonWithLabelAndBackgroundSprite(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControlButton_buttonWithBackgroundSprite(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControlButton_create(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControlButton_buttonWithTitleAndFontNameAndFontSize(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControlButton_node(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_CCScrollView_getDelegate(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_CCScrollView_node(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCScrollView_create(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCScrollView_viewWithViewSize(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCScrollView_CCScrollView(JSContext *cx, uint32_t argc, jsval *vp);

extern JSClass  *js_cocos2dx_CCMenuPassive_class;
extern JSObject *js_cocos2dx_CCMenuPassive_prototype;

JSBool js_cocos2dx_CCMenuPassive_constructor(JSContext *cx, uint32_t argc, jsval *vp);
void js_cocos2dx_CCMenuPassive_finalize(JSContext *cx, JSObject *obj);
void js_register_cocos2dx_CCMenuPassive(JSContext *cx, JSObject *global);
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_CCMenuPassive_alignItemsVertically(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCMenuPassive_setColor(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCMenuPassive_getColor(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCMenuPassive_setOpacity(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCMenuPassive_alignItemsHorizontallyWithPadding(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCMenuPassive_getOpacity(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCMenuPassive_alignItemsVerticallyWithPadding(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCMenuPassive_alignItemsHorizontally(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCMenuPassive_node(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCMenuPassive_menuWithItem(JSContext *cx, uint32_t argc, jsval *vp);

extern JSClass  *js_cocos2dx_CCEditBox_class;
extern JSObject *js_cocos2dx_CCEditBox_prototype;

JSBool js_cocos2dx_CCEditBox_constructor(JSContext *cx, uint32_t argc, jsval *vp);
void js_cocos2dx_CCEditBox_finalize(JSContext *cx, JSObject *obj);
void js_register_cocos2dx_CCEditBox(JSContext *cx, JSObject *global);
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_CCEditBox_keyboardDidShow(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_getText(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_setContentSize(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_visit(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_keyboardDidHide(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_getPlaceHolder(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_setInputMode(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_keyboardWillShow(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_setPlaceholderFontColor(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_setReturnType(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_setFontColor(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_keyboardWillHide(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_touchDownAction(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_setDelegate(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_initWithSizeAndBackgroundSprite(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_setPlaceHolder(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_setPosition(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_getMaxLength(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_setInputFlag(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_setText(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_setMaxLength(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_create(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCEditBox_CCEditBox(JSContext *cx, uint32_t argc, jsval *vp);
#endif
